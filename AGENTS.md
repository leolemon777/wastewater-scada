...
| `192.168.0.30` | 收集池液位 | `.72`(待确认) | 2026-08-19 确认现行 |
| `192.168.0.31` | 气浮前端控制(电柜,从默认 `.7` 改) | `.70` | 2026-08-19 确认现行 |
| `192.168.0.32` | 燃气进水流量计 | 待确认 | 2026-08-19 确认现行 |
| `192.168.0.33` | 药剂房电机 | `.78`?(待确认) | 2026-08-19 确认现行 |
