...
import { getTankWallPort, TANK_LAYOUT } from './tankLayout';
...
export const LIFT_PUMPS: ReadonlyArray<{
  ...
  // Keep every wall penetration away from a basin corner so the flange seats
  // on a real wall panel rather than the rounded/edge geometry.
...
export const COLLECTION_1_WORLD: V3 = [...TANK_LAYOUT['tk-collection-1'].center];
