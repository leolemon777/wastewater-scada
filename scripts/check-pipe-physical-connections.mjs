...
const pipe3d = read('src/components/3d/Pipe3D.tsx');
...
const convergingHeader = read('src/components/3d/ConvergingHeader3D.tsx');
const openFlange = read('src/components/3d/PipeOpenFlange3D.tsx');
const blindFlange = read('src/components/3d/PipeBlindFlange3D.tsx');
const wallPort = read('src/components/3d/PipeWallPort3D.tsx');
