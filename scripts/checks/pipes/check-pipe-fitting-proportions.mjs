...
const FITTING_RULES = [
  {
    file: 'src/components/3d/pipes/PipeWallPort3D.tsx',
    maxRadiusMultiplier: 1.24,
    maxLengthMultiplier: 0.08,
  },
  {
    file: 'src/components/3d/pipes/PipeOpenFlange3D.tsx',
    maxRadiusMultiplier: 1.26,
    maxLengthMultiplier: 0.15,
  },
  {
    file: 'src/components/3d/pipes/PipeBlindFlange3D.tsx',
    maxRadiusMultiplier: 1.26,
    maxLengthMultiplier: 0.12,
  },
];

const PIPE_3D = 'src/components/3d/pipes/Pipe3D.tsx';
const issues = [];
const stats = [];
