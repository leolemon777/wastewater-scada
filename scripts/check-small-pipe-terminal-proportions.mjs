...
function checkBlock({ relPath, startMarker, endMarker, label, expectedCount, maxRadius, maxLength }) {
  ...
  if (!/<Pipe3D\b|<AnchoredPipe3D\b|<PipeWallPort3D\b|CleanWaterHeaderTerminal|MeteringPumpBranch|DosingPort/.test(fileText)) {
...
checkBlock({
  relPath: 'src/components/3d/sections/ChemicalPipeRouting.tsx',
...
checkBlock({
  relPath: 'src/components/3d/sections/ChemicalDosingSection.tsx',
